...
# Album Launch Countdown - [JS Demo]

Music Album pre-release page demos the use of Apple-inspired glassmorphism and a timer widget to showcase the release countdown.

### Built with:
[![Pug.js][Pug.js]][Pug-url]  [![SCSS][Scss.css]][Scss-url]  [![JavaScript][Javascript.js]][Javascript-url]  [![jQuery][Jquery.js]][Jquery-url]
